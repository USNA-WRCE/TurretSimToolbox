function TurretSimToolboxUpdate
% TURRETSIMTOOLBOXUPDATE undates to the current version of the EW309 Corona
% Software package.
%
%   M. Kutzer, 01Apr2020, USNA

ToolboxUpdateWRCE('TurretSim');

end

function ToolboxUpdateWRCE(toolboxName)
...
% https://github.com/USNA-WRCE/%sToolbox/archive/refs/heads/main.zip
url = sprintf('https://github.com/USNA-WRCE/%sToolbox/archive/main.zip',toolboxName);
try
